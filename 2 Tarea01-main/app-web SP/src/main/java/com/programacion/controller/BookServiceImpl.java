...
public class BookServiceImpl implements BookService {
    ...
    //URI específica que queremos invocar para acceder a un recurso REST particular
    @Inject
    ...
    public String getBooks(Request request, Response response) {
        ...
        return new ThymeleafTemplateEngine().render(new ModelAndView(model, "vistaBooks"));
    }
    ...
    public String showUpdateBook(Request request, Response response) {
        ...
        return new ThymeleafTemplateEngine()
                .render(new ModelAndView(model, "vistaAgregarBooks"));
    }
