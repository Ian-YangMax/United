...
public class AuthorServiceImpl implements AuthorService {
    ...
    void updateAuthor(Author author, String id) {
        webTarget.path(String.format("/app2/authors/%s", id))
                .request(MediaType.APPLICATION_JSON)
    ...
    public String showUpdateAuthor(Request request, Response response) throws ParseException {
        ...
        Map<String, Object> model = new HashMap<>();
        var authorById = webTarget.path(String.format("/app2/authors/%s", id))
                .request(MediaType.APPLICATION_JSON_TYPE)
                .get(Author.class);
    ...
    public String deleteAuthor(Request request, Response response) {
        ...
        webTarget.path(String.format("/app2/authors/%d", id))
                .request(MediaType.APPLICATION_JSON_TYPE)
                .delete();
        response.redirect("/");
        return "";
